...
A structural anomaly in the standard deviations of goals and pledged amounts across outcomes uncovers one of the more revealing patterns in the dataset. For every outcome except successful campaigns, the standard deviation of goals exceeds that of pledged amounts, sometimes, substantially. For failed campaigns, the figures are $69,884 versus $45,775; for canceled campaigns, $70,557 versus $35,632; for live campaigns, $76,831 versus $52,170. In these cases, creators are setting goals across a wider range than the pledged amounts they ultimately receive: an example of aspirational goal-setting detached from what audiences are willing to support.

Conversely, successful campaigns invert this relationship entirely. Their standard deviation of pledged amounts ($64,552) exceeds that of goals ($40,734). There are two forces that produce this reversal. First, successful creators set more disciplined, realistic goals, compressing the goal distribution relative to other outcome groups: a standard deviation of $40,734 against $69,884 for failed and $70,557 for canceled campaigns. Second, once a campaign clears its goal, the final pledged amount is no longer bounded: it depends on how much additional support appears after the threshold is crossed, producing a wide and unpredictable range of over-funding outcomes that inflates the variance of pledged amounts.

The contrast between the two patterns is pointed. Failed and canceled campaigns possess wide goal dispersion and narrow pledge dispersion in which creators reach high, but audiences do not follow. Successful campaigns exhibit the opposite relationship: disciplined goals and expansive pledging. The standard deviation figures, read together, suggest that goal discipline is not merely correlated with success but structurally implicated in it.
