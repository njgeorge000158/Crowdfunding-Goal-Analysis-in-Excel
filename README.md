...
In addition, successful campaigns produce a substantially higher median funding ratio of 2.12x demonstrating that successful campaigns normally raise slightly over twice their goals. Among primary categories, Food and Photography record the highest median ratios followed by Games and Publishing. Technology is an outlier with the lowest median ratio despite possessing the highest primary category success rate. For this reason, Technology campaigns set precise goals relative to audience capacity clearing targets efficiently rather than generating excessive surplus.
