...
Campaign duration exhibits no statistically meaningful association with outcome in this dataset. Median duration is identical across successful and failed campaigns at 12 days, and the Spearman correlation between duration and percent funded is r ≈ −0.02 — a value indistinguishable from zero and directionally inconsistent with the intuition that longer campaign windows improve funding prospects.

The duration brackets broadly reflect this null result, though with two noteworthy features at the extremes. The 40–49 day bracket posts the highest success rate in the table at 62.7%, but with only 51 campaigns it is too thinly populated to support confident inference, and no mechanistic explanation distinguishes it from adjacent brackets in a way that would make the result replicable. More consequential is the 50–59 day bracket, where the success rate collapses to 36.4% — the lowest in the table and 20 percentage points below the overall average — while the failure rate rises to 54.5%. This pattern is consistent with a selection effect: creators who run the longest campaigns may disproportionately be those who extended their windows in response to poor early traction, making the 50–59 day cohort a population already skewed toward underperformance rather than evidence that long durations cause failure.

Collectively, the data offers no support for treating campaign duration as a lever for improving outcomes. Time on platform does not compensate for weak underlying demand, and creators who extend their campaign windows in response to poor early performance are unlikely to alter their trajectory by doing so. Duration is not a meaningful predictor of success in this dataset and should not be treated as a viable strategic variable.
