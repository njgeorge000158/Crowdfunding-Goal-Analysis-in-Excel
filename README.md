...
The median goal figures are consistent with and reinforce the success rate analysis.  Successful campaigns maintain a median goal of 6,200, compared to 9,900 for failed campaigns and 36,400 for canceled ones, a monotonically increasing gradient across outcome groups that, given its magnitude and consistency, is difficult to attribute to sampling variation.  The pattern is plausibly interpreted as evidence that goal discipline is a structural antecedent of success rather than a subsequent characteristic of it.  Creators whose goals are calibrated to the realistic capacity of their target audience appear more likely to reach them; conversely, those campaigns whose goals exceed that capacity appear more likely to fall short or withdraw entirely.
