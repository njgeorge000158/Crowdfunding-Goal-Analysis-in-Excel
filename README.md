...
Monthly success rates exhibit a broad seasonal trend punctuated by two anomalies.  Rates rise from 53.8% in January to 64.0% in June, remain elevated through September, and decline thereafter — a trajectory consistent with stronger backer engagement through the mid-year period and reduced engagement toward year-end.  However, two months deviate materially from this pattern.  August records a success rate of 48.8%, a decline of 13.6 percentage points from the preceding month and the lowest rate observed across the full calendar year, despite its position within the prosperous mid-year window. May records 54.8%, interrupting a spring increase that had progressed steadily from January through April without an analogous reversal in the preceding or following months.
