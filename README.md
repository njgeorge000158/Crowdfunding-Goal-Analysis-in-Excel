...
The association between dual endorsement and elevated success rates is more consistent with selection than with treatment.  Crowdfunding platforms have the operational capacity and the institutional incentive to award promotional status to campaigns already demonstrating strong performance indicators — early backer momentum, pledge velocity, presentation quality — rather than distributing endorsements in a manner that would allow causal inference.  Under this interpretation, the higher success rate observed among doubly endorsed campaigns is the result of the platform's selection of high-quality campaigns for endorsement rather than any causal effect on campaign outcomes.  That is to say, the endorsements function as a signal of underlying quality rather than a source of it, and the observed lift should be ascribed accordingly.
