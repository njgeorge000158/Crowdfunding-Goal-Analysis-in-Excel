...
Annual success rates across the 2010–2019 period ranged from 51.0% to 67.0%, exhibiting oscillatory rather than directional variation. To this end, rates reached their highest levels during 2017–2019 and their lowest during 2015–2016, demonstrating no sustained upward or downward momentum across the decade as a whole.  The absence of a directional trend suggests the platform's underlying success dynamics neither systematically improved as the platform matured nor deteriorated as competition intensified.  The two campaigns recorded for 2020 both failed, but, with a such a small subsample, the observation carries no statistical weight and cannot be interpreted as indicative of any directional shift.
...
However, this interpretation is subject to a structural constraint inherent in the dataset rather than any analytical ambiguity in the findings. With annual subsamples averaging about 100 campaigns, the resolution of the year-on-year analysis is sufficient to identify broad shifts but insufficient to detect gradual trends convincingly.  Reliable differentiation between genuine structural change and cyclical variation would require observation an order of magnitude or more above those available in this dataset before multi-year trend analysis could reliably distinguish such structural changes from cyclical variations with confidence.
