...
The two distributional patterns stand in direct contrast.  Failed and canceled campaigns are characterized by wide goal dispersion and narrow pledge dispersion, consistent with aspirational goal-setting that audiences do not validate.  Successful campaigns exhibit the opposite relationship, low goal variance and high pledge variance, consistent with disciplined goals and expansive pledging.  The standard deviation figures, read together, suggest that goal discipline is not merely correlated with success but structurally implicated in it.
