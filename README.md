...
The subcategory findings are broadly consistent with the primary category pattern. The highest-performing subcategories — Web / Technology (70.6%), Translations / Publishing (66.7%), Television / Film & Video (64.7%), and Wearables / Technology (62.2%) — are drawn predominantly from higher-performing primary categories, reinforcing the view that primary category selection is a worthwhile predictor of success. One notable exception that Television / Film & Video outperforms its parent category by 7.4 percentage points despite Film & Video's mid-range ranking, suggesting that subcategory dynamics are not fully determined by primary category membership and that analysis at both levels is warranted before drawing conclusions about competitive positioning.
