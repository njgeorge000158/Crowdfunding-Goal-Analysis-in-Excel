...
Yet, this conclusion is subject to a structural constraint inherent in the dataset rather than any analytical ambiguity in the findings. With annual subsamples averaging about 100 campaigns, the resolution of the year-on-year analysis is enough to identify broad shifts but insufficient to detect gradual trends reliably.  Thus, a credible multi-year trend analysis would require, at minimum, annual observations an order of magnitude above those available here.
