...
As a final point, the monthly success analysis identifies a mid-year window of relative strength and two periods of relative weakness. Uniformly above the 57.3% overall average, June, July, and September record success rates between 61.6% and 64.0%. At the opposite end, August and December post the two lowest rates at 48.8% and 51.9% respectively. In other words, these outcomes depict the mid-year window as the most favorable environment and the late summer and year-end periods as the least.
