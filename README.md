...
Collectively, the data offers no support for treating campaign duration as an option for improving outcomes. The time on platform does not compensate for weak underlying demand, and creators who extend their campaign windows in response to poor early performance are unlikely to alter their trajectory by doing so. Duration is not a legitimate predictor of success in this dataset and should not be treated as a viable strategic variable.
